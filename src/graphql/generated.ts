...
export type GetLessonBSlugLQueryVariables = Exact<{
  slug?: InputMaybe<Scalars['String']>;
}>;


export type GetLessonBSlugLQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', title: string, videoId: string, description?: string | null, teacher?: { __typename?: 'Teacher', name: string, bio: string, avatarURL: string } | null } | null };

export type GeLessonsQueryVariables = Exact<{ [key: string]: never; }>;


export type GeLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', id: string, lessonType: LessonType, availableAt?: any | null, title: string, slug: string }> };
...
export const GetLessonBSlugLDocument = gql`
    query GetLessonBSlugL($slug: String) {
...
/**
 * __useGetLessonBSlugLQuery__
 *
 * To run a query within a React component, call `useGetLessonBSlugLQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetLessonBSlugLQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetLessonBSlugLQuery({
 *   variables: {
 *      slug: // value for 'slug'
 *   },
 * });
 */
export function useGetLessonBSlugLQuery(baseOptions?: Apollo.QueryHookOptions<GetLessonBSlugLQuery, GetLessonBSlugLQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetLessonBSlugLQuery, GetLessonBSlugLQueryVariables>(GetLessonBSlugLDocument, options);
      }
export function useGetLessonBSlugLLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetLessonBSlugLQuery, GetLessonBSlugLQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetLessonBSlugLQuery, GetLessonBSlugLQueryVariables>(GetLessonBSlugLDocument, options);
        }
export type GetLessonBSlugLQueryHookResult = ReturnType<typeof useGetLessonBSlugLQuery>;
export type GetLessonBSlugLLazyQueryHookResult = ReturnType<typeof useGetLessonBSlugLLazyQuery>;
export type GetLessonBSlugLQueryResult = Apollo.QueryResult<GetLessonBSlugLQuery, GetLessonBSlugLQueryVariables>;
export const GeLessonsDocument = gql`
    query GeLessons {
...
/**
 * __useGeLessonsQuery__
 *
 * To run a query within a React component, call `useGeLessonsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGeLessonsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGeLessonsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGeLessonsQuery(baseOptions?: Apollo.QueryHookOptions<GeLessonsQuery, GeLessonsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GeLessonsQuery, GeLessonsQueryVariables>(GeLessonsDocument, options);
      }
export function useGeLessonsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GeLessonsQuery, GeLessonsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GeLessonsQuery, GeLessonsQueryVariables>(GeLessonsDocument, options);
        }
export type GeLessonsQueryHookResult = ReturnType<typeof useGeLessonsQuery>;
export type GeLessonsLazyQueryHookResult = ReturnType<typeof useGeLessonsLazyQuery>;
export type GeLessonsQueryResult = Apollo.QueryResult<GeLessonsQuery, GeLessonsQueryVariables>;
